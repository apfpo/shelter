...
function getdetails(obj) {
     let name = obj.id;
     let pet = allPets.find(pet => pet.name === name)
     const window = document.querySelector('.popup')
     window.style = "visibility: visible"

     const name_pet = document.querySelector('.popup-name')
     ...
     const close_btn = document.querySelector('.popup-close')

     name_pet.innerHTML = pet.name;
     img.src = pet.img;
